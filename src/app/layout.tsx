...
export const metadata: Metadata = {
  title: 'ProdakBot - AI Chat Assistant',
  description: 'Chat with ProdakBot, your friendly AI assistant for any question.',
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="ProdakBot" />
